# Global settings for photologue; based on the example project.
...
ROOT_URLCONF = 'snake_pics.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'snake_pics/templates'),
                 os.path.join(BASE_DIR, 'snake_pics/snake_pics/templates'),
...
WSGI_APPLICATION = 'snake_pics.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'snake_pics/static'),
)
